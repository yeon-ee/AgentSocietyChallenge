...
if __name__ == "__main__":
    ...
    simulator = Simulator(data_dir="/root/AgentSocietyChallenge/data/processed", device="auto", cache=True)

    # Load scenarios
    simulator.set_task_and_groundtruth(task_dir=f"/root/AgentSocietyChallenge/example/track2/amazon/tasks", groundtruth_dir=f"/root/AgentSocietyChallenge/example/track2/amazon/groundtruth")

    # Set your custom agent
    simulator.set_agent(MyRecommendationAgent)

    # Set LLM client
    simulator.set_llm(OpenAILLM(api_key=api_key))

    # Run evaluation
    # If you don't set the number of tasks, the simulator will run all tasks.
    agent_outputs = simulator.run_simulation(number_of_tasks=10, enable_threading=True, max_workers=5)
